defmodule ArraySliceTest do
  ...
  test "halve size 2" do
    ...
    assert ArraySlice.reify_list(left) == [1]
    assert ArraySlice.reify_list(right) == [2]
  end
  ...
  test "halve_arr size 3" do
    ...
    assert ArraySlice.reify_list(left) == [1]
    assert ArraySlice.reify_list(right) == [2, 3]
  end
  ...
  test "halve_arr size 4" do
    ...
    assert ArraySlice.reify_list(left) == [1, 2]
    assert ArraySlice.reify_list(right) == [3, 4]
  end
end
